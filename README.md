# react-live-clock-port

Python-port of the react-live-clock to integrate with plotly dash (forked from https://github.com/pvoznyuk/react-live-clock) 
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> react-live-clock-port -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import react-live-clock-port to your layout, then run it:
